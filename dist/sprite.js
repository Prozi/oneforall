...
var Sprite = exports.Sprite = function (_PIXI$Sprite) {
    _inherits(Sprite, _PIXI$Sprite);

    function Sprite(gameObject, texture) {
        _classCallCheck(this, Sprite);

        var _this = _possibleConstructorReturn(this, (Sprite.__proto__ || Object.getPrototypeOf(Sprite)).call(this, texture));
